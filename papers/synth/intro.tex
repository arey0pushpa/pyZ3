...
%
%The activity of SNARE proteins is further regulated by their interaction with other traffic molecules. 

%\ashu{ [do we need the following], such as SMproteins~\cite{sudhof2009membrane} and proteins of tethering complexes~\cite{hong2014tethering}. }
%
...
%
We also consider variations on the properties against which we do
