...
%
We model the system as a labeled graph, where compartments are nodes and transport vesicles are edges. Molecular compositions of the compartments and vesicles are given by node and edge labels respectively. These molecules can be active or inactive on any given compartment or vesicle. The activity state of molecules is also included in the node and edge labels. Consistently with the SNARE picture, a vesicle is enabled by a set of molecules such that one part of the set occurs in the vesicle and the other part occurs in the target compartment. 
...
%
Not all sets of molecules can participate in the fusion; in real biological cells, fusogenic SNARE complexes are discovered through experiments. 
...
%
In the model, we assume that the system is in steady state and the concentrations of the molecules in compartments do not change over time.
%
