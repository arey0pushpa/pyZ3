...
We also need to encode that encode that
...
%
In the following constraints, we assume the appropriate encoding is
...
replace the above constraints with parameterized constraints that
