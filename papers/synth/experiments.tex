...
We implemented the encodings in a tool called~\ourtool\footnote{\ashu{\url{http://add-git-hub-url}}}.
%
...
motifs in VTSs. 
%
The last two are the VTSs that are from .......\ashu{Describe the source of two examples}.
