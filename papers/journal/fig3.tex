...
%	  \path (pm) edge[bend left=30] node [above,rotate=-45,text width = 2.5cm] {{R2} {Qa7} Qbc7, R7, Qc7, Qa2, \color{blue} { \textbf{R3}}} (ee);	    
  ...
  \end{subfigure}%
  \caption{An example of the synthesis of edge and molecules in the partial VTS. Black edges correspond to the edges in the input VTS and the synthesized edge is shown in the red color. Similarly, synthesized molecules are shown in blue color.} \label{fig:synth-vts}
\end{figure}
