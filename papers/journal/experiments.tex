...
%
We will refer to existential subblocks \unsure{The fonts of toolset looks different make them uniform. The reason is valid although.}as {\sattool} and {\smttool}, universal block as {\qbftool} and synthesis block as {\ourtool}.
%
...
\subsection{Results}
\noindent The results and timings of three blocks of the {\vtstool} are presented in the table~\ref{tab:smt-grph} and table~\ref{tab:satsmt-graph}, for both {\sattool} and {\smttool}, in table~\ref{tab:qbf-graph} for {\qbftool} and in table~\ref{tab:synth-graph} for~{\ourtool}.
