...
%
We will present Figure~\ref{fig:vts-search}, two encodings for existential condition and one each for universal condition condition and synthesis.
...
\begin{tikzpicture}
\begin{customlegend}[legend columns=-1,legend style={draw=none,column sep=1ex},legend entries={ \small Problem Statement, \small Encodings}]
