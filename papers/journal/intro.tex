...
\subsubsection{Vesicle budding} The process of vesicle budding involves sorting and packaging of cargo molecules, membrane deformation and budding of the vesicle from the source compartment (Figure~\ref{fig:vts}).
%
...
\begin{example}
    ...
    %
    Every molecule present on the node is active. 
    %
    The activity of the molecules on an edge is determined by the presence of the other molecules.
    %
    The synthesis is performed against the stability and 3-connectivity. 
