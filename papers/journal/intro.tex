...
Vesicles were discovered decades ago, in the early 1950s, and major molecules of the vesicle traffic system and their functions were discovered soon after~\cite{wells2005discovery}. 
%
These molecules can roughly be categorized as budding molecules, whose role is in the formation and budding of transport vesicles from the source compartment, and fusion molecules, which enable fusion of transport vesicles with the target compartments. 
%
...
\ankit{A template: Requires rewriting and some explanation}
%
\todo{Ankit: The Rothman model has no intuition; Add couple of lines relating it to VTS; Also, relate it to previous subsection. The connect is lacking.} The VTS model for this paper is inspired by~\cite{shukla2017discovering}. 
%
...
\begin{enumerate}
\item A cell is a set of compartments exchanging molecules via vesicles of uniform size.
\item On the timescale of minutes, compartments are neither created nor destroyed.
\item Each compartment is in steady state, gain and loss of the molecules is balance\todo{Ankit: Need intuition and also reasoning why this is okay to add this as an assumption}.
\item We assume that molecules are neither created nor destroyed.
...
\todo{Ankit: Need some additional discussion;4 lines max about the legitamecy of the assumptions.}
...
\ankit{Requires rewriting and better explanation}
...
%
\ankit{Added this as a template. Will change it soon.}
\begin{example}
%
...
\ankit{Needs revision; overlapping writing.}
