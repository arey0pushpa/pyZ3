...
\begin{example}
	%
	In figure~\ref{fig:synth-vts}, we present a partial VTS that has 3 compartments and it's complete VTS. The synthesis is performed on the basis of steady state property and the  k-connectivity of the graph.
