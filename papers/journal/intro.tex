...
%
In Sect.~\ref{sec:model}, we present graph model of VTSs.
%
%encoding of several constraints on VTSs. 
%
In Sect.~\ref{sec:property}, we present the properties of interest.
%
In Sect.~\ref{sec:problem}, we present formal problem statement of the verification properties.
%
