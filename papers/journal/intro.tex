...
\begin{example}
	...
	%
	The synthesis is performed against the steady state property and 3-connectivity. The tags PM, EE, and LE represent the corresponding nodes (please refer to Appendix~\ref{sec:ex-vts} for proper discussion about the nodes and molecules). 
	%
