...
A cell is a set of compartments exchanging molecules via vesicles of uniform size.
%
...
%
The identities of compartments and vesicles is encoded in their molecules, and identical vesicles fuse with identical target compartments.
%
Fusion of vesicles to compartments is driven by specific SNARE pairing, and a single active SNARE complex is necessary and sufficient for fusion.
%
...
%
It is possible that a different scheme for the dynamics could lead to a different set of solution
...
%
The tools model the computation symbolically for the graphs of finite size and can verify the and hence make prediction about the hypothesis for all possible states of the system. 
%
