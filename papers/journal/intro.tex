...
%
Given a traffic rule and an initial condition, the system is updates one step a time, updating molecular flux of the compartments, until a steady state is reached. 
%
