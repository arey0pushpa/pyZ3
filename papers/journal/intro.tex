...
%
Another interesting question of property involving quantifiers (was termed as sufficient condition in \cite{shukla2017discovering}; in this paper, we call it universal condition) was partly handled using sampling and left open as future work.
%
...
\par We have implemented the encoding in a flexible tool, which can handle both connectivity question and a wide range of synthesis queries. 
%
