...
\begin{figure}
	\includegraphics[width=0.8\textwidth,natwidth=610,natheight=642]{diavts.jpg}
...
\subsubsection{Graph connectivity is an interesting and accessible property of the VTS}
\ankit{This section requires serious work and best written by Mukund.}
