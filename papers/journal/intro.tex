...
\end{enumerate}
     %   \item Lastly, interpreting experimental results can be difficult, since behaviour of traffic molecules in vitro is different from their behavior inside cells.
