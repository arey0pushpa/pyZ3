...
%\end{align*}
%
For examplei, the edges are represented as a bitvectors of size M with each bit corresponding to the presence or the absence of the molecule. 
%
...
\begin{align}
 \bigwedge\limits_{i,j,m} (\bigvee_{q} bv\_e[i][j][q] \limplies NOracle(m, j, i, w)
