...
\noindent Our first attempt was to encode the existential condition check as a $\fbmc$ search problem~\cite{shukla2017discovering}.
%
...
% 
In comparison to $\fsmt$, the $\fbmc$ search encodes reachability (both for the stability and connectivity) differently.  
%]
