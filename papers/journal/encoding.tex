...
\textbf{Constraints for stability condition}
%
...
% 
As an experiment we have implemented a trivial SMT version of the universal problem extending the current SMT encodings.
%
...
\input{satqbf-table}
%
The table~\ref{tab:satqbf-graph}, shows results of search result of universal condition for N = 4, 3-connected graphs. The SAT version was not able to scale it to the desired results and either timed-out (T/O) or ran out of memory (M/O).
%
