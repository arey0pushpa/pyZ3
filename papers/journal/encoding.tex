...
%To check whether $k$-connected is a necessary condition, 
...
%We have used logarithmic bitwise encoding to express the cardinality constraint that exactly $k-1$ edges are dropped. 
%To encode exactly $k$ edges are dropped we need to express cardinality constraint to allow exactly $k$ edges to be true from set of all present edges $e$. 
%
