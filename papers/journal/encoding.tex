...
In the $\fbmc$ encoding, the label of the edges and nodes are represented by variables of type arrays of bit vector of size $M$. 
%
...
For clarity, we consider the first part of the bit vector as Q-SNAREs and rest as R-SNAREs.
%
For example, the variable \texttt{bvEdge}[0][2][1] = $1001$, means the molecule  $M_{1}$ (Q-SNARE) and $M_{4}$ (R-SNARE) are present on the first edge between node 2 and node 1.
