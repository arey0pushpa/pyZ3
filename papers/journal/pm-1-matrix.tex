...
\tikzset{
 ...
 \node[state,place](a) {$N_{0}: Q_{a1} {\color{red} Q_{b1}} Q_{c1}$ $\color{red}Q_{a2} Q_{b2} {\color{red}Q_{c2}}$ $Q_{a3} Q_{b3} Q_{c3}$ $Q_{a4} Q_{b4} Q_{c4}$ $R_{1} R_{2} R_{3} R_{4}$};
 \node[state,place,right=of a] (b) {$N_{1}: Q_{a1} {\color{red} Q_{b1}} Q_{c1}$ $\color{red}Q_{a2} Q_{b2} {\color{red}Q_{c2}}$ $Q_{a3} Q_{b3} Q_{c3}$ $Q_{a4} Q_{b4} Q_{c4}$ $R_{1} R_{2} R_{3} R_{4}$};  
 \draw
