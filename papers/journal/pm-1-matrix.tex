...
thick,main node/.style={circle,draw,font=\sffamily,minimum size=1.0cm}]
\begin{scope}[]

\node[main node] (1) {$N_{0}$};
\node[main node] (2) [right of=1] {$N_{1}$};
%\node[main node] (3) [below right of=1] {$s_{3}$};

\path[every node/.style={font=\sffamily\small}]
%(3) edge node [left] {} (1)
(1) edge [bend right=65] node [left] {} (2)
(2) edge [bend right=65] node[right] {} (1)
