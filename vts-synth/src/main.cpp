...
int main(int ac, char* av[]) {
   ...
   */
    ...
    variation.add_options()("func-type,f", value<int>(),
                            "fix a function type for QBF")(
        "synth-var,s", value<int>(), "fix a synthesis variation for vts");

    options_description options("Available options");
    options.add_options()("use-z3,z", "use z3 for QBF solving")(
        "print-model,p", "print vts model")("display-graph,g",
                                            "display the vts as graph")(
