...
\node[above=10pt of m-1-1] (top-1) {$M_1$};
\node[above=10pt of m-1-2] (top-2) {$M_2$};
\node[above=10pt of m-1-3] (top-3) {$M_3$};
\node[above=10pt of m-1-4] (top-4) {$M_4$};
\node[above=10pt of m-1-5] (top-5) {$M_5$};
\node[above=10pt of m-1-6] (top-6) {$M_6$};
\node[above=10pt of m-1-7] (top-7) {$M_7$};
\node[above=10pt of m-1-8] (top-8) {$M_8$};
...
\node[left=10pt] at (del-left-1.west) {$Q-Snares$};
...
\node[left=10pt] at (del-left-2.west) {$R-Snares$};
...
%}
\foreach \element in {m-1-7,m-2-6,m-3-5}{
\highlight[blue!50]{\element}{\element}
}
\end{pgfonlayer}
