...
\begin{tikzpicture}[node distance = 30mm]
  \node[draw] (n0) {$n_1:\overline{01234}$};
  \node[draw,below left of=n0] (n1) {$n_0:\overline{01236}$};
  \node[draw,below right of=n0] (n2) {$n_2:\overline{012368}$};

  \draw[->,thick] (n1) -- node[left=1mm]  {$0\overline{1}$} (n0);
  \draw [->,thick] (n1) to [bend right=-30] node[left=1mm]  {$\overline{01}23$} (n0);
