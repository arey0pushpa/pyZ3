...
The problem of encoding graph connectivity and stability condition in CBMC was solved combined non-determinism and partial enumeration that is not as efficient.\newline
