...
If a VTS is $k$-connected, every pair of compartments remain reachable after dropping $k-1$ vesicles. In principle the connectivity of a VTS can be determined by cell-biological studies.
