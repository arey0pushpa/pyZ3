...
eukaryotic cells with a total number of 10 compartments. \textbf{Not only we have improved finding a SAT model but this encoding also did better in comparison to cbmc in the
case of refutation that no model exists. Refer table variant A timing
